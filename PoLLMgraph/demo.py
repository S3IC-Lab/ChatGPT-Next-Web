...
HF_NAMES = {
    ...
    "llama2_13B": "/home/chuokun_xu/model/Llama-2-13b-hf",
    "alpaca_13B": "circulus/alpaca-13b", # chavinlo/alpaca-13b 
...
def perform_inference(input_text):
    ...
    if llm == "llama2_7B":
        tokenizer = AutoTokenizer.from_pretrained(DtmcModel)
...
def main():
    ...
    # print("start training dtmc model")
